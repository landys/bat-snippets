...
msbuild "Kernel\Projects\VisualizationEngineClientProject\VisualizationEngineClient\VECore\VECore.vcxproj" /t:Rebuild /p:Configuration=Debug_Use_Msi_COM /p:Platform="Win32"

rem patch to DSSDataImport.h and build DSSController
cleartool unco Kernel\SourceCode\OneTierClient\DSSDataImport.h
...
msbuild "Kernel\Projects\OneTierClientProject\OneTierClientApp\DSSController\DSSController.vcxproj" /define:DATAIMPORT_DLL_EXPORT /t:Rebuild /p:Configuration=Debug_Use_Msi_COM /p:Platform="Win32"
...
msbuild "Kernel\Projects\VisualizationEngineClientProject\VisualizationEngineClient\VETest\VETest.vcxproj" /t:Rebuild /p:Configuration=Debug_Use_Msi_COM /p:Platform="Win32"
